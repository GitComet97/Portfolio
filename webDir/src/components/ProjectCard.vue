<template>
  <div class="md:w-full h-80 perspective overflow-hidden group pr-4 md:pr-0">
    <div
      class="relative w-full h-full duration-500 transform-style-preserve-3d group-hover:rotate-y-180 will-change-transform"
    >
      <!-- Front Side -->
      <div
        class="absolute inset-0 bg-gray-800 rounded-lg p-4 flex flex-col justify-start backface-hidden"
      >
